...
for(var i = 0 ; i < allCards.length; i++){
    allCards[i].addEventListener('click', function(event){
        cardIcon = event.target.firstElementChild.firstElementChild.classList[1];
        flipCard(event);
...
//             setTimeout(noMatchFlipAllOpen,3000);
//         }   
//     }
...
//  function noMatchFlipAllOpen(){ 
//     var openCards = document.getElementsByClassName("open");

//     for(var i = 0; i <= openCards.length; i++){
//         console.log("counter is: "+ i + " and card : "+openCards[i]);
